...
import 'package:uts_mobile_2201092049/screen.page/login_api.dart';
import 'package:uts_mobile_2201092049/screen.page/profile_user.dart';
        ...
        children: [
          Padding(
            ...
            child: ClipRRect(
              ...
              child: Image.network(
                "http://192.168.100.6/uts_mobile/image/${data?.gambar}",
                fit: BoxFit.fill,
              ),
            ),
          ),
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http.get(
        Uri.parse("http://192.168.100.6/uts_mobile/berita.php"),
      );
