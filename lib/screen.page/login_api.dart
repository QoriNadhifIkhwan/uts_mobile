...
import 'package:uts_mobile_2201092049/model/model_login.dart';
import 'package:uts_mobile_2201092049/screen.page/list_berita.dart';
import 'package:uts_mobile_2201092049/screen.page/register_api.dart';
import 'package:uts_mobile_2201092049/utils/session_manager.dart';
...
class _LoginApiState extends State<LoginApi> {
  ...
  Future<ModelLogin?> loginAccount() async{
    ...
    try{
      ...
      http.Response response = await http.post(Uri.parse('http://192.168.100.6/uts_mobile/login.php'),
          body: {
